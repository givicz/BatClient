...
import me.BATapp.batclient.mixin.access.NativeImageAccessor;
...
class GlyphMap {
    ...
    private Font getFontForGlyph(char c) {
        font.canDisplay(c);
        return this.font; // no fonts can display it, so it doesn't matter which one we pick; it'll always be missing
    }
